...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("Tunggu ya lagi loading...!", quote = True)
    try:
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("Link Buat Di Share", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"<b>Ini Linknya buat member Tuan</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
